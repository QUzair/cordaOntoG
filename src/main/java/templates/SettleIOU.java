...
public class SettleIOU {
    ...
    public static class Initiator extends IOUBaseFlow {
        ...
        public Initiator(UniqueIdentifier linearId, Amount<Currency> amount) {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final Amount<Currency> amountToSettle = inputObligation.getValue();
            ...
            final Command settleCommand = new Command<>(new IOUContract.Commands.Settle(), requiredSigners);
            ...
            final FlowSession session = initiateFlow(inputObligation.getLender());
