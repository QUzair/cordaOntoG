...
abstract class IOUBaseFlow extends FlowLogic<SignedTransaction> {
    ...
    StateAndRef<IOUState> getObligationByLinearId(UniqueIdentifier linearId) throws FlowException {
        ...
        List<StateAndRef<IOUState>> obligations = getServiceHub().getVaultService().queryBy(IOUState.class, queryCriteria).getStates();
